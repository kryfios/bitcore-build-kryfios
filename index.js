...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-kryfios/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-kryfios -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-kryfios -o bitcore-lib-kryfios.js';
    }
